  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-6">
        <span className="font-display text-[10rem] font-bold leading-none text-text-primary/5 select-none">500</span>
        <div className="-mt-20 flex flex-col items-center gap-4">
          ...
          <h1 className="font-display text-3xl font-bold text-text-primary">Unexpected Error</h1>
          <p className="font-body text-base text-text-muted max-w-sm">
            Something broke on our end. Don't worry — it's not you.
          </p>
          {error.digest && (
            <code className="font-mono text-[10px] text-text-faint bg-surface border border-text-primary/5 px-3 py-1 rounded">
              Error: {error.digest}
            </code>
          )}
          <div className="flex gap-3 mt-2">
            <button
              onClick={reset}
              className="px-6 py-3 rounded-full bg-gradient-to-r from-accent-pink to-accent-purple text-text-primary font-mono text-xs font-bold uppercase tracking-wider hover:brightness-110 transition-all active:scale-95"
            >
              Try Again
            </button>
            <Link
