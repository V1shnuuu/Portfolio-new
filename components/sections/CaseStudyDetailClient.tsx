  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h1 className="font-display text-4xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-4">
          {cs.title}
        </h1>
      ...
      <div className="w-full aspect-video bg-surface-elevated rounded-2xl border border-white/10 flex items-center justify-center relative overflow-hidden">
        <span className="font-mono text-[10rem] font-bold text-white/5 select-none">CS</span>
      ...
      <section className="flex flex-col gap-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-display text-2xl font-bold text-white">The Process</h2>
        </div>
        ...
        <div className="pl-11 flex flex-col gap-4">
          {cs.process.map((step, idx) => (
            <m.div
              ...
              className="flex gap-4 p-5 bg-surface border border-white/5 rounded-xl"
            >
      ...
      <section className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-display text-2xl font-bold text-white">The Solution</h2>
        </div>
        <div className="pl-11">
      ...
      {/* Testimonial */}
      {cs.testimonial && (
        <section className="bg-surface border border-white/5 rounded-2xl p-8">
          <Quote className="w-8 h-8 text-accent-cyan/30 mb-4" />
          <blockquote className="font-body text-lg text-white italic leading-relaxed mb-6">
            "{cs.testimonial.text}"
          </blockquote>
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display text-sm font-bold text-white">{cs.testimonial.author}</div>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2">
          {cs.tech.map(t => (
            <span key={t} className="font-mono text-xs text-text-muted bg-surface border border-white/10 rounded-full px-4 py-1.5">
              {t}
            </span>
          ))}
        </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-white/5">
        <Link href="/case-studies" className="inline-flex items-center gap-2 font-mono text-xs text-text-muted hover:text-white transition-colors">
        ...
        {cs.projectId && (
          <Link
            ...
            className="inline-flex items-center gap-2 font-mono text-xs text-accent-violet hover:text-white transition-colors"
          >
            View Project →
          </Link>
        )}
